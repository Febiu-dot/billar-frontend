...
{ a: '/admin/ranking',            etiqueta: 'Ranking por Fases',     icono: 'k' },
{ a: '/admin/ranking-final',      etiqueta: 'Ranking del Circuito',  icono: '🏆' },
{ a: '/admin/ranking-acumulado',  etiqueta: 'Ranking Acumulado',     icono: '📊' },
