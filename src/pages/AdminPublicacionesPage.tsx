        ...
        <div style={{ flex: 1, textAlign: 'center', position: 'relative', zIndex: 2 }}>
          ...
          {data.formato && (
            <div style={{
              ...
              borderRadius: 8, padding: '7px 30px',
              fontFamily: "'Saira Condensed', sans-serif",
              fontSize: 14, fontWeight: 800, letterSpacing: '0.10em',
              color: CV2.goldBright,
  ...
  return (
    <div className="bk-stage" ref={stageRef} style={{ ...cssVars, width: 1440, fontFamily: "'Rajdhani', sans-serif" } as React.CSSProperties}>
      <style>{`
        ...
        .bk-center{display:flex;flex-direction:column;align-items:center;gap:12px;padding:0 4px;}
